...
public abstract class ChangeLedColorCommandTest {
    ...
    should_return_a_byte_array () {
        ChangeLedColorCommand command = createCommand(new RGBColor(100, 200, 200), BlinkLed.ALL_LEDS);
    ...
    abstract protected ChangeLedColorCommand createCommand(RGBColor color, BlinkLed led);
}
